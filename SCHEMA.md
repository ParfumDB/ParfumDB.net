...
| column | description |
|---|---|
| `n_id` | Primary key, always a single value. Compound ids are gone as of v1.11 — merged ids now live in `n_id_aliases_p` and every pyramid reference points at the primary row. |
| `slug`, `name`, `url` | Identity. |
